...
export function getRuntimeConfig() {
  ...
  return {
     ...
     *
     * The two are released on separate tags, so this number answers only for
     * the site. The rules answer for themselves: the engine image carries its
     * own version and the gateway reads it at runtime.
     */
    siteVersion: requiredEnv("EKKO_SITE_VERSION", "local"),
